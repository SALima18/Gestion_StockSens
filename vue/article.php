            ...
            <table class="mtable">
                ...
                ?>
                        <tr>
                            ...
                            <a onclick="annuleArticle(<?= $value['id'] ?>)" style="color: red;"><i class='bx bx-stop-circle'></i></a>
...
?>
<script>
function annuleArticle(id) {
    if (confirm("Voulez-vous vraiment supprimer cet article ?")) {
        window.location.href = "../model/annulArticle.php?id=" + id;
    }
}
</script>